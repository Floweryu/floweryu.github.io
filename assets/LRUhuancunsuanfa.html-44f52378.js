import{_ as n,o as s,c as a,d as e}from"./app-4805b28f.js";const p={},t=e(`<h2 id="双向链表-哈希表-非线程安全" tabindex="-1"><a class="header-anchor" href="#双向链表-哈希表-非线程安全" aria-hidden="true">#</a> 双向链表+哈希表（非线程安全）</h2><p>https://leetcode.cn/problems/lru-cache/solutions/259678/lruhuan-cun-ji-zhi-by-leetcode-solution/</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * LRU算法: 哈希表+双向链表实现
