import{_ as n,o as s,c as e,d as a}from"./app-194b491d.js";const i="/assets/3fa252bdbb174ebb9315293442e72f91tplv-k3u1fbpfcp-watermark-5174d2ce.png",t="/assets/ea2b11fe35bd4ac694ac5bd173d6f54ftplv-k3u1fbpfcp-watermark-20af8b8f.png",r="/assets/df85901275254794a89c0a3dc22ff503tplv-k3u1fbpfcp-watermark-e227f332.png",l="/assets/2e9e8fc6f7184f26a5fe8eeadeef0b7etplv-k3u1fbpfcp-watermark-e28f1917.png",o="/assets/42f36eeea66e4dbfa65f0176b7c51150tplv-k3u1fbpfcp-watermark-a0e9fd1e.png",c="/assets/3bfbc50de4bb4954950467a9658bf9aetplv-k3u1fbpfcp-watermark-df02282d.png",p="/assets/2d9b6c01aa0f40f1ae999213644a4503tplv-k3u1fbpfcp-watermark-49bb9ee2.png",u={},d=a('<h2 id="一、服务发现" tabindex="-1"><a class="header-anchor" href="#一、服务发现" aria-hidden="true">#</a> 一、服务发现</h2><p>RocketMQ有下面几个角色</p><p><strong>NameSrv: 注册中心</strong></p><p><strong>Broker: 消息服务器</strong></p><p><strong>Producer: 消息生产者</strong></p><p><strong>Consumer: 消息消费者</strong></p><p>RocketMQ没有使用Zookeeper作为服务的注册中心，而是自研的NameSrv，每个NameSrv都是无关联的节点。</p><p>当消息服务器启动后，会将自己的地址信息等，注册到所有的NameSrv。</p><p><img src="'+i+'" alt="image.png"></p><p>当Producer和Consumer启动后，会主动连接NameServer，获取可用的Broker列表，并选取Broker进行连接，进行消息发送与拉取。</p><p><img src="'+t+'" alt="image.png"></p><h2 id="二、源码分析" tabindex="-1"><a class="header-anchor" href="#二、源码分析" aria-hidden="true">#</a> 二、源码分析</h2><h3 id="_2-1-路由注册" tabindex="-1"><a class="header-anchor" href="#_2-1-路由注册" aria-hidden="true">#</a> 2.1 路由注册</h3><p>在源码的broker包根目录下，有一个<code>BrokerStartup</code>启动类。</p><p><img src="'+r+`" alt="image.png"></p><p>入口代码如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> public static void main(String[] args) {
...
<span class="token punctuation">}</span>
 ...
 producer.start();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面先告知Producer NameSrv 的地址，紧接着调用了<strong>start</strong>启动生产者。</p><p><img src="`+p+`" alt="image.png"></p><p>下面会执行到<strong>org.apache.rocketmq.client.impl.factory.MQClientInstance#startScheduledTask</strong>方法，该方法也启动了一些任务：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>private void startScheduledTask() {
	......
