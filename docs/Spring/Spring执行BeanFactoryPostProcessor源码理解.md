...
![image-20230730203029711](https://floweryu-image.oss-cn-shanghai.aliyuncs.com/image202307302031012.png)

## 源码理解

源码位于`PostProcessorRegistrationDelegate#invokeBeanFactoryPostProcessors`方法，这里省略了上下文，需要知道该方法是在`BeanFactory`准备完成后调用，位置如下图所示：

![image-20230730203053823](https://floweryu-image.oss-cn-shanghai.aliyuncs.com/image202307302031111.png)
